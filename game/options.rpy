...
define gui.about = _("This Fan mod call Doki Doki Literature Club With Ironmouse fan mod for the Vtuber/youtuber ironmouse and she the new Student in the club. ")
...
# main menu.
define config.main_menu_music = audio.t1r
